            ...
            <div class="card-block">
                ...
                <div class="form-group row"> 
	                <div class="col-sm-12"> 
		                ...
		                <div class="col-sm-12"> 
		                    {{ Form::text('serv_solicitado', $estancia->serv_solicitado,  ['class' => 'form-control','placeholder'=>'Servicio solicitado']) }}
		                </div>
	                </div>
                </div> 
                <!---->
                ...
                <div class="form-group row"> 
                  <div class="col-sm-6"> 
                      ...
                      <div class="col-sm-12"> 
                        {{ Form::text('nom_solicitado', $estancia->nombre_completo,  ['class' => 'form-control','placeholder'=>'Nombre solicitante']) }}
                      </div>
                  </div>
                  <div class="col-sm-6"> 
                      <label class="col-sm-12 col-form-label">Correo electrónico: </label>
                      <div class="col-sm-12"> 
                        {{ Form::text('correo', $estancia->correo,  ['class' => 'form-control','placeholder'=>'Correo electrónico']) }}
                      </div>
                  </div>
                </div>
                <!---->
                <div class="form-group row"> 
                  <div class="col-sm-6"> 
                      ...
                      <div class="col-sm-12"> 
                        {{ Form::text('empresa', $estancia->empresa,  ['class' => 'form-control','placeholder'=>'Empresa']) }}
                      </div>
                  </div>
                  <div class="col-sm-6"> 
                      <label class="col-sm-12 col-form-label">Dirección: </label>
                      <div class="col-sm-12"> 
                        {{ Form::text('direccion', $estancia->direccion,  ['class' => 'form-control','placeholder'=>'Dirección']) }}
                      </div>
                  </div>
                </div>
                <!---->
                <div class="form-group row"> 
                  <div class="col-sm-6"> 
                      ...
                      <div class="col-sm-12"> 
                        {{ Form::text('rfc', $estancia->rfc,  ['class' => 'form-control','placeholder'=>'RFC']) }}
                      </div>
                  </div>
                  <div class="col-sm-6"> 
                      <label class="col-sm-12 col-form-label">Teléfono: </label>
                      <div class="col-sm-12"> 
                        {{ Form::text('telefono', $estancia->telefono,  ['class' => 'form-control','placeholder'=>'Teléfono']) }}
                      </div>
                  </div>
                </div>
                <!---->
                <div class="form-group row"> 
                  <div class="col-sm-6"> 
                      ...
                      <div class="col-sm-12"> 
                        {{ Form::text('celular', $estancia->celular,  ['class' => 'form-control','placeholder'=>'Celular']) }}
                      </div>
                  </div>
                  <div class="col-sm-6"> 
                      <label class="col-sm-12 col-form-label">Forma de pago: </label>
                      <div class="col-sm-12"> 
                        {{ Form::text('form_pago', $estancia->forma_pago,  ['class' => 'form-control','placeholder'=>'Forma de pago']) }}
                      </div>
                  </div>
                </div>
                <!---->
                <div class="form-group row"> 
                  <div class="col-sm-6"> 
                      ...
                      <div class="col-sm-12"> 
                        {{ Form::text('pago_persona', $estancia->pago_x_persona,  ['class' => 'form-control','placeholder'=>'Pago por Persona']) }}
                      </div>
                  </div>
                  <div class="col-sm-6"> 
                      <label class="col-sm-12 col-form-label">Total a Pagar: </label>
                      <div class="col-sm-12"> 
                        {{ Form::text('total_pagar', $estancia->total_pagar,  ['class' => 'form-control','placeholder'=>'Total a Pagar']) }}
                      </div>
                  </div>
                </div>
                <!---->
                <div class="form-group row"> 
                  <div class="col-sm-3"> 
                      ...
                      <div class="col-sm-12"> 
                        {{ Form::text('anticipo', $estancia->anticipo,  ['class' => 'form-control','placeholder'=>'Anticipo']) }}
                      </div>
                  </div>
                  <div class="col-sm-3"> 
                      <label class="col-sm-12 col-form-label">Saldo:</label>
                      <div class="col-sm-12"> 
                        {{ Form::text('saldo', $estancia->saldo,  ['class' => 'form-control','placeholder'=>'Saldo']) }}
                      </div>
                  </div>
                  <div class="col-sm-3"> 
                      <label class="col-sm-12 col-form-label">Número de Personas:</label>
                      <div class="col-sm-12"> 
                        {{ Form::text('num_persona', $estancia->num_persona,  ['class' => 'form-control','placeholder'=>'Número de Personas']) }}
                      </div>
                  </div>
                  <div class="col-sm-3"> 
                      <label class="col-sm-12 col-form-label">Total</label>
                      <div class="col-sm-12"> 
                        {{ Form::text('total', $estancia->total,  ['class' => 'form-control','placeholder'=>'Total']) }}
                      </div>
                  </div>
                </div>
                <!---->
                <div class="form-group row"> 
                  <div class="col-sm-4"> 
                      ...
                      <div class="col-sm-12"> 
                        {{ Form::textarea('inst_usar', $estancia->inst_usar,  ['class' => 'form-control','placeholder'=>'Instalaciones que van a usar']) }}
                      </div>
                  </div>
                  <div class="col-sm-4"> 
                      <label class="col-sm-12 col-form-label">Especificaciones del evento o servicio:</label>
                      <div class="col-sm-12"> 
                        {{ Form::textarea('esp_evento', $estancia->esp_evento,  ['class' => 'form-control','placeholder'=>'Especificaciones del evento o servicio']) }}
                      </div>
                  </div>
                  <div class="col-sm-4"> 
                      <label class="col-sm-12 col-form-label">Servicios de SPA:</label>
                      <div class="col-sm-12"> 
                        {{ Form::textarea('serv_spa', $estancia->serv_spa,  ['class' => 'form-control','placeholder'=>'Servicios de SPA']) }}
                      </div>
                  </div>
                </div>
                <!---->
                <div class="form-group row"> 
                  <div class="col-sm-6"> 
                      ...
                      <div class="col-sm-12"> 
                        {{ Form::text('contacto_de', $estancia->contacto_de,  ['class' => 'form-control','placeholder'=>'Contacto de']) }}
                      </div>
                  </div>
                  <div class="col-sm-6"> 
                      <label class="col-sm-12 col-form-label">Seguimiento y atendido por:</label>
                      <div class="col-sm-12"> 
                        {{ Form::text('seg_atendido', $estancia->seg_atendido,  ['class' => 'form-control','placeholder'=>'Seguimiento y atendido por']) }}
                      </div>
                  </div>
                </div>
                <!---->
