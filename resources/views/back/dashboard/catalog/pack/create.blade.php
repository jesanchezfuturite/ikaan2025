        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    {{ Form::open(['url' => url('cms/dashboard/catalogo/paquetes/store') ]) }}
                        ...
                        <div class="tab-pane container active" id="home">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    {{ Form::time('checkin', null, ['class' => 'form-control']) }}
                                </div>
                                <div class="col-sm-2">
                                    <div class="row">
                                        <label class="col-sm-12 col-form-label">Check out</label>
                                    </div>
                                    {{ Form::time('checkout', null, ['class' => 'form-control']) }}
                                </div>
                            </div>
                            ...
                            <div class="form-group row" style="background: #f1f1f1; padding: 15px; border-radius: 10px;">
                                <label class="col-sm-6 col-form-label">Galería de habitación</label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    {{ Form::select('maximum_people', [1 => "1", 2 => 2, 3 => 3, 4 => 4] ,null, ['class' => 'form-control']) }}
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="price_sencilla" step="any" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        <span class="input-group-addon">$</span>
                                        <input type="number" name="price_doble" step="any" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" style="background: #f1f1f1; padding: 15px; border-radius: 10px;">
                                ...
                                <div class="col-sm-12 disp-ib" id="caracteristicas_group">
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="caracteristica_name[]" />
                                        <div class="input-group-append">
                                            <button class="btn btn-danger" type="button" onclick="$(this).parent().parent().remove();">Eliminar</button>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    {{ Form::select('deal', $deal ,null, ['class' => 'form-control']) }}
                                </div>
                            </div>
...
@section('pageJS')
    ...
    {{ Html::script('/back/js/dashboard/catalog/pack/general.js')  }}
@stop
