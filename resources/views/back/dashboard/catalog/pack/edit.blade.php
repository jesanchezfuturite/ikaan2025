...
@section('pageTopButton')
    <a href="{{ url('cms/dashboard/catalogo/paquetes') }}" class="btn btn-info"><i class="icofont icofont-rewind"></i> Regresar</a>
@stop
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    {{ Form::open(['url' => url('cms/dashboard/catalogo/paquetes/update/'.$id) ]) }}
                    ...
                    <div class="tab-content">
                        <div class="tab-pane container active" id="home">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">Hora de Check in / Check out</label>
                                <div class="col-sm-2">
                                    <div class="row">
                                        <label class="col-sm-12 col-form-label">Check in</label>
                                    </div>
                                    {{ Form::time('checkin', $data->checkin, ['class' => 'form-control']) }}
                                </div>
                                <div class="col-sm-2">
                                    <div class="row">
                                        <label class="col-sm-12 col-form-label">Check out</label>
                                    </div>
                                    {{ Form::time('checkout', $data->checkout, ['class' => 'form-control']) }}
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    {{ Form::number('nights', $data->nights, ['class' => 'form-control']) }}
                                </div>
                            </div>
                                ...
                                <div class="row width-100">
                                    @foreach($data->get_gallery() as $item)
                                        <div class="col-sm-3 text-right">
                                            ...
                                            <button class="btn btn-danger" type="button" href="{{ url('cms/dashboard/catalogo/paquetes/remove_image/')."/".$item->id }}" onclick="remove_picture($(this));" style="margin-top: -61px;">Eliminar</button>
                                        </div>
                                    @endforeach
                                </div>
                                ...
                                <div class="col-sm-12 disp-ib" id="caracteristicas_group">
                                    ...
                                    @foreach($data->get_characteristics() as $item)
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="input-group-append">
                                                <button class="btn btn-danger" type="button" href="{{ url('cms/dashboard/catalogo/paquetes/remove_caracteristica/')."/".$item->id }}" onclick="remove_caracteristica($(this));">Eliminar</button>
                                            </div>
                                        </div>
                                    @endforeach
                        ...
                        <div class="tab-pane container fade" id="menu1">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">Selecciona los días en los que el paquete no estará disponible.</label>
                                <div class="col-sm-12">
...
@section('pageJS')
    ...
    {{ Html::script('/back/js/dashboard/catalog/pack/edit.js')  }}
@stop
