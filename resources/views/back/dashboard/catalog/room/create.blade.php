        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    {{ Form::open(['url' => url('cms/dashboard/catalogo/habitaciones/store') ]) }}
                    ...
                    <div class="tab-content">
                        <div class="tab-pane container active" id="home">
                            ...
                            {{--<div class="form-group row">--}}
                                {{--<label class="col-sm-12 col-form-label">IVA (porcentaje)</label>--}}
                                {{--<div class="col-sm-12">--}}
                                    {{--<div class="input-group">--}}
                                        {{--<span class="input-group-addon">%</span>--}}
...
@section('pageJS')
    ...
    {{ Html::script('/back/js/dashboard/catalog/room/general.js')  }}
@stop
