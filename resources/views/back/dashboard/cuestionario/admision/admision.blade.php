        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-block">
                    {{ Form::open(['url' => url('cms/dashboard/cuestionario/admision/update/'.base64_encode($admision->id)) ]) }}
                    	<div class="form-group row">
                            <label class="col-sm-1 col-form-label">Folio*</label>
                            <div class="col-sm-2">
                                {{ Form::text('folio', $admision->id, ['class' => 'form-control']) }}
                            </div>
                            <label class="col-sm-1 col-form-label">Nombre*</label>
                            <div class="col-sm-8">
                                {{ Form::text('nombre', $admision->nombre, ['class' => 'form-control']) }}
                            </div>
                        </div>
                        <!---->
                    	<div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                {{ Form::date('fec_entrada', $admision->fecha_entrada, ['class' => 'form-control']) }}
                            </div>
                            <label class="col-sm-2 col-form-label">Fecha de Salida*</label>
                            <div class="col-sm-4">
                                {{ Form::date('fec_salida', $admision->fecha_salida, ['class' => 'form-control']) }}
                            </div>
                        </div>
                        <!---->
                    	<div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                {{ Form::date('fec_nac', $admision->fecha_nacimiento, ['class' => 'form-control']) }}
                            </div>
                            <label class="col-sm-2 col-form-label">Correo electrónico*</label>
                            <div class="col-sm-4">
                                {{ Form::text('correo_elec', $admision->correo, ['class' => 'form-control']) }}
                            </div>
                        </div>
                        <!---->
                    	<div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('telefono', $admision->telefono, ['class' => 'form-control']) }}
                            </div>
                            <label class="col-sm-2 col-form-label">Celular*</label>
                            <div class="col-sm-4">
                                {{ Form::text('celular', $admision->celular, ['class' => 'form-control']) }}
                            </div>
                        </div>
                        <!---->
                    	<div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                {{ Form::date('fech_aniver', $admision->fecha_aniversario, ['class' => 'form-control']) }}
                            </div>
                            <label class="col-sm-2 col-form-label">Forma de pago*</label>
                            <div class="col-sm-4">
                                {{ Form::text('forma_pago', $admision->forma_pago, ['class' => 'form-control']) }}
                            </div>
                        </div>
                        <!---->
                    	<div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select name="edad" class="form-control">
                                    <option value="{{$admision->edad}}">{{$admision->edad}}</option>
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('lugar_asignado', $admision->lugar_asignado, ['class' => 'form-control']) }}
                            </div>
                        </div>
                        <!---->
                    	<div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('servicio_solic', $admision->servicio_solicitado, ['class' => 'form-control']) }}
                            </div>
                            <label class="col-sm-2 col-form-label">Padece alguna enfermedad*</label>
                            <div class="col-sm-4">
                            	<?php 
                            	if ($admision->alguna_enfermedad == "ninguna") {?>
	                            	<select name="alguna_enfer" class="form-control" id="colorselector">
	                            		<option value="{{$admision->alguna_enfermedad}}">{{$admision->alguna_enfermedad}}</option>
                            	...
                            	<?php  }elseif($admision->alguna_enfermedad == "otro") {?>
	                            	<select name="alguna_enfer" class="form-control" id="colorselector">
	                            		<option value="{{$admision->alguna_enfermedad}}">{{$admision->alguna_enfermedad}}</option>
                       ...
                       <?php } ?>
                    	...
                    	<div class="form-group row">
                            ...
                            <div class="col-sm-4">
                            	<?php 
                            	if ($admision->alergia == "si") {?>
	                            	<select name="alergico" class="form-control" id="colorselector2">
	                            		<option value="{{$admision->alergia}}">{{$admision->alergia}}</option>
                    	...
                    	<div class="form-group row">
                            ...
                            <div class="col-sm-4">
                            	<select name="como_se_entero" class="form-control" id="como_se_entero">
                            		<option value="{{$admision->como_se_entero}}">{{$admision->como_se_entero}}</option>
                            ...
                            <div class="col-sm-6">
                            	<?php 
                            	if ($admision->como_se_entero == "Otro") {?>
                            	<div class="output">
								  	<div id="Otro" class="colors yellow">
				                    	<div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <button type="submit" class="btn btn-primary btn-save"><i class="icofont icofont-save"></i> Descargar</button>
                            </div>
                        </div>
                    {{ Form::close() }}
                </div>
