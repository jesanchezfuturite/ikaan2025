        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5>Evaluación de la reservación</h5>
                ...
                <div class="card-block">
                    ...
                    <div class="form-group row"> 
	                    <div class="col-sm-12"> 
		                    ...
		                    <div class="col-sm-12"> 
                                {{ Form::hidden('id', $evaluacion->id,  ['class' => 'form-control','placeholder'=>'Nombre','readonly'=>'readonly']) }}

		                        {{ Form::text('nombre', $evaluacion->cli->nombre_completo,  ['class' => 'form-control','placeholder'=>'Nombre','readonly'=>'readonly']) }}
		                    </div>
	                	</div>
                    </div> 
                    <!---->
                    <div class="form-group row">
                    	<div class="col-sm-6">
		                    ...
		                    <div class="col-sm-12"> 
		                        {{ Form::text('fecha_entrada',$evaluacion->fecha_entrada,  ['class' => 'form-control','placeholder'=>'Fecha Entrada','readonly'=>'readonly']) }}
		                    </div>
                    	</div>
                    	<div class="col-sm-6">
	                    	<label class="col-sm-12 col-form-label">Fecha Salida</label>
		                    <div class="col-sm-12"> 
		                        {{ Form::text('fecha_salida',$evaluacion->fecha_salida,  ['class' => 'form-control','placeholder'=>'Fecha Salida','readonly'=>'readonly']) }}
		                    </div>
                    	</div>
                    </div> 
                    <!---->
                    <div class="form-group row">
                    	<div class="col-sm-6">
		                    ...
		                    <div class="col-sm-12"> 
		                        {{ Form::text('email',$evaluacion->cli->email,  ['class' => 'form-control','placeholder'=>'Correo electrónico','readonly'=>'readonly']) }}
		                    </div>
                    	</div>
                    	<div class="col-sm-6">
	                    	<label class="col-sm-12 col-form-label">Teléfono</label>
		                    <div class="col-sm-12"> 
		                        {{ Form::text('telefono',$evaluacion->cli->telefono,  ['class' => 'form-control','placeholder'=>'Teléfono','readonly'=>'readonly']) }}
		                    </div>
                    	</div>
                    </div>  
                    <!---->
                    <div class="form-group row">
                    	<div class="col-sm-6">
		                    ...
		                    <div class="col-sm-12"> 
		                        {{ Form::text('celular',$evaluacion->cli->celular,  ['class' => 'form-control','placeholder'=>'Cel','readonly'=>'readonly']) }}
		                    </div>
                    	</div>
                    	<div class="col-sm-6">
